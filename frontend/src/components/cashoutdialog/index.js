...
export default class CashoutDialog extends React.Component {
  ...
  setValueReaches(e) {
    ...
    if (a > max || a < parseFloat(parseFloat(min).toPrecision(12))) {
      states.valueError = !0; states.ErrorMSG = 'The specified amount is out of the acceptable range.'
    } else { states.valueError = !1; states.ErrorMSG = '' }
  ...
  setPartialVal(e) {
    ...
    if (c) {
      ...
      let states = {};
      if (d > c) {
        states.valueError = !0; states.ErrorMSG = 'Please enter a valid Cash-out amount.'
      } else { states.valueError = !1; states.ErrorMSG = '' }
