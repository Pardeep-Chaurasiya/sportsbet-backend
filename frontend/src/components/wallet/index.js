...
export default class Wallet extends React.Component {
  ...
  attemptDeposit() {
    ...
    const {
      ...
      $hash = calcMD5(
        `AuthToken${AuthToken}uid${uid}email${email}type${paymentOptions[openedItem].id}amount${amount}${telcoType === 2 ? `voucher${voucher}` : ""
                                            ...
                                            <div className="liquid-child ember-view">
                                              ...
                                              >
                                                <div className="sb-login-form-wrapper">
                                                  <div
                                                    className={`form ${openedItem !== index
                                                      ? "animated fadeOut"
                                                      : "fadeIn animated"
                                                      }`}
                                                          ...
                                                          <div className="form-group required">
                                                            <div className="form-element empty">
                                                              <div className="input-wrapper ">
                                                                ...
                                                                />
                                                                <span
                                                                  className={`placeholder ${externalAcc === "" &&
                                                      ...
                                                      <div className="form-element empty">
                                                        <div className="input-wrapper  show-password-switcher">
                                                          <div className="field-icons-container ember-view">
                                                            ...
                                                            >
                                                              <span
                                                                className={`password-visibility icon ${showPass ? "icon-sb-hide" : "icon-sb-show"
                                                                  }`}
                                                              ></span>
                                                            </div>
                                                          </div>
