...
export default class RegisterFrom extends React.Component {
  ...
  canContinue() {
    const { password, phoneNumber, firstname, lastname, email, terms } =
      this.state;
    return (
      password === "" ||
      phoneNumber === "" ||
  ...
  verifyPhone() {
    ...
    if (
      ...
      if (email === "" || !validateEmail(email)) dirty.emailEmpty = true;
                ...
                <div data-step="sign-up" className="sb-login-step active ">
                  ...
                  <div className="sb-login-form-wrapper">
                    ...
                    {created ? (
                      ...
                      >
                        <p
                          className="recaptcha-version-3"
                          style={{ fontSize: "20px" }}
                        >
                          Thank You for joining Drives, Your Account was created
                          successfully!
                        </p>
                      ...
                      >
                        ...
                        <span>
                          We have sent an SMS code to the number : {phoneNumber}
                        </span>
                        <p
                                  ...
                                  <div className="password-visibility-block">
                                    {canResend ? (
                                      <div
                                        ...
                                        title="resend"
                                        className="password-visibility icon icon-sb-refresh"
                                      ></div>
                                    ) : (
                                      <span
                                        title="count down"
                                        className="password-visibility count-down"
                                      >
                                        {countdown}
                                      </span>
                                    )}
                        ...
                        <button
                          ...
                          onClick={this.attemptSignup.bind(this)}
                          className="sb-account-btn btn-primary submit-join-now "
                          type="submit"
                        >
                          {attemptingSignup ? (
