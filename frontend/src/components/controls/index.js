  ...
  placeBet() {
    ...
    if (Object.keys(betSelections).length > 0) {
      ...
      Object.keys(betSelections).forEach((selected) => {
        ...
        //   betSelections[selected].marketBase
        //     ? betSelections[selected].eventBases === 0
        //       ? betSelections[selected].eventBases
        //         ? "(0)"
        //         : ""
        //       : `(${betSelections[selected].marketBase})`
        //     : ""
        // }`;
        if (betSelections[selected].eventBases == undefined) {
          eventDetails["SelectionName"] = `${betSelections[selected].pick}`;
        }
        // else if (betSelections[selected].eventBases === 0) {
        //   eventDetails["SelectionName"] = `${
        //     betSelections[selected].pick
        //   }${`(${betSelections[selected].eventBases})`}`;
        // }
        else {
          eventDetails[
            "SelectionName"
          ] = `${betSelections[selected].pick}(${betSelections[selected].eventBases})`;
        }
                          ...
                          <div className="betslip-body">
                                    ...
                                    {enableFreebet ? (
                                      ...
                                      >
                                        <div className="betslip-quick-bet-container open">
                                          <OddsSettings
                                            onChange={this.setFreeBetStake.bind(
                                              this
                                            )}
                            ...
                            {betlen > 0 ? (
                              ...
                              <div className="betslip-empty guest">
                                <span>
                                  No bets have been selected. To bet, please
                                  click on the respective result.
                                </span>
                              </div>
                            )}
                          </div>
